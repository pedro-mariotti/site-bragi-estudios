  ...
  return (
    <div id="gallery">
      <div className="lg:h-screen h-max lg:grid w-full bg-[url('../public/bg-preto.png')] bg-cover bg-top md:grid-cols-8">
        ...
        <div className="flex flex-col items-center justify-center lg:h-full gap-7 md:col-span-3 px-12 pb-24">
          <div className="text-purple z-20 w-full ">
            <div className="inline-block p-4 bg-[#ffffff] shadow-lg font-semimedium h-96 overflow-y-scroll sm:overflow-hidden">
