...
export const SliderData = [
  {
    ...
    descricao_pt: 'Você pode ser um conquistador de órbitas. Salte de uma órbita para outra evitando as órbitas vermelhas. Libere os novos níveis coletando as estrelas amarelas e azuis. Cuidado para não mandar sua nave para o espaço!',
  ...
  },
  {
    ...
    descricao_pt: 'O objetivo do jogo é descobrir rapidamente qual elemento tem uma cor diferente. Acerte muitas cores seguidas para ganhar pontos ofensivos e aumentar sua pontuação!',
    publisher_pt: '',
  ...
  },
  {
    ...
    descricao_pt: 'O 100NHAS Fugaz é um spin-off desenvolvido na pandemia de Covid-19, com 20 novos enigmas para você e sua família resolverem em casa. #ficaemcasa',
    publisher_pt: '',
  ...
  },
  {
    ...
    descricao_pt: 'Building Sort é um jogo Puzzle Sorting no qual você deve organizar os andares dos edifícios trocando suas posições. Troque os edifícios estrategicamente para trazer ordem ao caos.',
    publisher_pt: '',
  ...
  },
  {
    ...
    descricao_pt: 'Um jogo arcade simples e divertido: Clique nos TOCs indicados para ganhar pontos. Mas cuidado, se você clicar nos TOCs errados, perderá pontos!',
    publisher_pt: '',
  ...
  },
  {
    ...
    descricao_pt: 'Jogo desenvolvido para a Game Jam Magalu, em menos de 48 horas! Wood Cutter é um jogo de precisão e atenção. Crie a melhor estratégia para cortar, com precisão, um bloco de madeira com os moldes disponíveis - antes que acabem suas lâminas.',
    publisher_pt: '',
  ...
  },
  {
    ...
    descricao_pt: 'Uma vaca é abduzida para um planeta estranho e colocada em uma prisão. Ao conseguir fugir, começa a explorar o novo mundo buscando formas de voltar para casa. É um jogo de aventura e puzzles, em plataforma 360°.',
    publisher_pt: '',
